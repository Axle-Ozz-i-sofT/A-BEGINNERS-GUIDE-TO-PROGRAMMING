# FreeBASIC Sqlite 3 wrapper functions and Examples  
  
  This is a collection of FreeBASIC warapper functions and examples to illustrate methods of interacting with the SQLite 3 .dll/.so.  
...
There are 2 FB source modules in this repo and are organised as follows:  

* **example_calls.bas**  
	A collection of basic examples that interact with the SQLite in a number of different ways. This set of examples makes use of a collection of wrapper functions contained in "example_sql3.bi". Both "example_calls.bas" and "example_sql3.bi" are just examples and convenience wrappers to highlight some of the common methods as well as some of the different ways of interacting with the SQLite library.  
...
* **example_sql3.bi**  
	...
	Use the wrapper functions as a guide for different tasks and methods from which you can practice designing your own database application. Some methods are shared between example_calls.bas and example_sql3.bi.  
